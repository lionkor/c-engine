...
extern void    vector_clear(Vector*);                            // sets the size to 0, keeps capacity, memsets data to 0x0
extern void    vector_erase(Vector*, void* iter);                // erases the element at the pointer and shifts everything around a bit.
